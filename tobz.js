...
module.exports = tobz = async (tobz, message) => {
    try {
        ...
        const ownerNumber = '6289509938750@c.us'
...
➸ *Wilayah:* +${region_name}`
        ...
        case prefix+'setstatus':
            if (!isOwner) return tobz.reply(from, `Perintah ini hanya bisa di gunakan oleh Owner ▀▄▀▄ᖽᐸᗩᑘᘻ ᕼᗩᒪᑘ√▄▀▄▀!`, id)
        ...
        case prefix+'help':
            ...
            break
        case prefix+'KaumHalugroup':
            tobz.reply(from, `Link Group ▀▄▀▄ᖽᐸᗩᑘᘻ ᕼᗩᒪᑘ√▄▀▄▀ : https://chat.whatsapp.com/DTYZirAR5jwH8qfU1gxSeI\nJangan Lupa Join Ya Kak ${pushname}`, id)
            break
        ...
        case prefix+'adminmenu':
            if (!isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin ▀▄▀▄ᖽᐸᗩᑘᘻ ᕼᗩᒪᑘ√▄▀▄▀', id)
            tobz.sendText(from, admincmd)
            break
        case prefix+'ownermenu':
            if (!isOwner) return tobz.reply(from, 'Perintah ini hanya untuk Owner ▀▄▀▄ᖽᐸᗩᑘᘻ ᕼᗩᒪᑘ√▄▀▄▀', id)
